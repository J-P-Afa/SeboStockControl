...
describe('LanguagesPage', () => {
  beforeEach(() => {
    server.use(
      ...
      http.get(`${API_URL}/dashboard/sales-comparison`, ({ request }) => {
        ...
        expect(params.get('dimension')).toBe('languageId');
  ...
  it('renders the language sales comparison dashboard', async () => {
    renderPage();
    ...
    expect(screen.getByText('Comparativo de vendas por idioma')).toBeInTheDocument();
  });
});
