...
describe('ListUsersUseCase', () => {
    ...
    it('should list users successfully', async () => {
        ...
        expect(userRepository.findAll).toHaveBeenCalledWith(1, 10, 'createdAt', 'desc', undefined);
    });
    ...
    it('should list users with filters', async () => {
        ...
        // Assert
        expect(userRepository.findAll).toHaveBeenCalledWith(1, 10, 'name', 'asc', filters);
    });
});
