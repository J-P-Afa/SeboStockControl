...
export class BookEntity {
  ...
  public static create(props: Omit<BookProps, 'id' | 'createdAt' | 'updatedAt'>): BookEntity {
  ...
  get subtitle(): string | null | undefined { return this.props.subtitle; }
  get author(): string | null | undefined { return this.props.author; }
  get isbn13(): string | null | undefined { return this.props.isbn13; }
  get isbn10(): string | null | undefined { return this.props.isbn10; }
  get listPrice(): Prisma.Decimal | null | undefined { return this.props.listPrice; }
  get editionType(): EditionType { return this.props.editionType; }
  get volume(): string | null | undefined { return this.props.volume; }
  get collection(): string | null | undefined { return this.props.collection; }
  get condition(): Condition { return this.props.condition; }
  get status(): Status { return this.props.status; }
  get publicationYear(): number | null | undefined { return this.props.publicationYear; }
  get pages(): number | null | undefined { return this.props.pages; }
  get synopsis(): string | null | undefined { return this.props.synopsis; }
  get dimensions(): string | null | undefined { return this.props.dimensions; }
  get weight(): Prisma.Decimal { return this.props.weight; }
  ...
  get classificacaoId(): number | null | undefined { return this.props.classificacaoId; }
  get isActive(): boolean { return this.props.isActive; }
  get createdAt(): Date { return this.props.createdAt; }
  get updatedAt(): Date { return this.props.updatedAt; }
  get estoqueQuantidade(): number | null | undefined { return this.props.estoqueQuantidade; }

  public update(props: Partial<Omit<BookProps, 'id' | 'createdAt' | 'updatedAt'>>): void {
  ...
  public desativar(): void { this.props.isActive = false; }
  public ativar(): void { this.props.isActive = true; }
}
